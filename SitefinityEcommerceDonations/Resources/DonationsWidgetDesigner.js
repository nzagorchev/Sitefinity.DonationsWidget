...
SitefinityEcommerceDonations.DonationsWidgetDesigner = function (element) {

    SitefinityEcommerceDonations.DonationsWidgetDesigner.initializeBase(this, [element]);
...
SitefinityEcommerceDonations.DonationsWidgetDesigner.prototype = {

    /* --------------------------------- set up and tear down --------------------------------- */

    initialize: function () {
        this.refreshUI();
        SitefinityEcommerceDonations.DonationsWidgetDesigner.callBaseMethod(this, 'initialize');
    ...
    dispose: function () {
        ...
        SitefinityEcommerceDonations.DonationsWidgetDesigner.callBaseMethod(this, 'dispose');
    },
...
SitefinityEcommerceDonations.DonationsWidgetDesigner.registerClass('SitefinityEcommerceDonations.DonationsWidgetDesigner', Sys.UI.Control, Telerik.Sitefinity.Web.UI.ControlDesign.IControlDesigner);